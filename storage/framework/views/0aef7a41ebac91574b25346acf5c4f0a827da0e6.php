                ...
                <div class="n-intro">
                    <div class="n-intro__info">
                        ...
                        <div class="n-intro__row">
                            <a href="<?php echo e(route('pages.catalog.maincategory', 'jianghai')); ?>" class="btn btn-next--blue" data-fancybox data-src="#modal1">В каталог<span class="span-arrow"></span></a>
                    ...
                    <div class="n-intro__image">
                        <div class="n-intro__image-wrap">
                            <img src="<?php echo e(asset('/img/product/n-intro_image2.png')); ?>" alt="">
                        </div>
                    </div>
                    ...
                    <div class="n-advantages__wrap">
                        <div class="n-advantages__item">
                            <div class="n-advantages__image">
                                <img src="<?php echo e(asset('/img/product/n-advantage_image1.svg')); ?>" alt="">
                            </div>
                        ...
                        <div class="n-advantages__item">
                            <div class="n-advantages__image">
                                <img src="<?php echo e(asset('/img/product/n-advantage_image2.svg')); ?>" alt="">
                            </div>
                            <div class="n-advantages__descr">Существенно более низкая цена и сроки поставок.</div>
                        </div>
                        <div class="n-advantages__item">
                            <div class="n-advantages__image">
                                <img src="<?php echo e(asset('/img/product/n-advantage_image3.svg')); ?>" alt="">
                            </div>
        ...
        <div class="container container_small">
            ...
            <div class="catalog__wrap">
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image9.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>Radial <br/>capacitors</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'radial')); ?>" class="btn btn-next--blue">
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image10.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>Snap-in <br/>capacitors</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'snapin')); ?>" class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image11.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>Screw <br/>capacitors</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'screw')); ?>" class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image12.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>Polyimer <br/>capacitors</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'polymer')); ?>" class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image13.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>Film <br/>capacitors</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'film-capacitors')); ?>" class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
...
<?php echo $__env->make('front.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/d/dmitryty/test.palmeri.us/resources/views/front/pages/jianghai.blade.php ENDPATH**/ ?>