            ...
            <div class="n-intro">
                ...
                <div class="n-intro__image">
                    <div class="n-intro__image-wrap">
                        <img src="<?php echo e(asset('/img/product/n-intro_image1.png')); ?>" alt="">
                    </div>
                </div>
                <div class="n-intro__bg">
                    <img src="<?php echo e(asset('/img/product/n-intro_bg2.svg')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="n-about__row">
                ...
                <div class="n-about__image">
                    <div class="n-about__image-wrap">
                        <img src="<?php echo e(asset('/img/product/about_image1.jpg')); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="n-about__row">
                ...
                <div class="n-about__image">
                    <div class="n-about__image-wrap">
                        <img src="<?php echo e(asset('/img/product/about_image2.jpg')); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="n-about__row">
                ...
                <div class="n-about__image">
                    <div class="n-about__image-wrap">
                        <img src="<?php echo e(asset('/img/product/about_image3.jpg')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container container_small">
            ...
            <div class="catalog__wrap">
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image1.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>BG | EC Motors</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'bg-brushless-dc-motors')); ?>" class="btn btn-next--blue">
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image2.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>GR/G | Brushed <br/>DC Motors</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'grg-brushed-dc-motors')); ?>" class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image3.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>KD/DR | AC motors</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href=<?php echo e(route('pages.catalog.category.subcategory', 'kddr-ac-motors')); ?> class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image4.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>D/DCD | Venetian <br/>blind drives</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'ddcd-venetian-blind-drives')); ?>" class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image5.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>PLG/SG/STG | <br/>Gearboxes</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'plgsgstg-gearboxes')); ?>" class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image6.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>BGE | Controllers</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'bge-controllers')); ?>" class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image7.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>Brakes and <br/>Encoders</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'e-brakes')); ?>" class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="catalog-card">
                    <div class="card__image"><img src="<?php echo e(asset('/img/product/catalog_image8.png')); ?>" alt=""></div>
                    <div class="card__content">
                        <p><span>Linear Systems</span></p>
                    </div>
                    <div class="card__bottom n-intro__row">
                        <a href="<?php echo e(route('pages.catalog.category.subcategory', 'stcasmlsm-linear-systems')); ?>" class="btn btn-next--blue">
                            <span class="sp-text">В каталог</span>
                            <span class="span-arrow"></span>
                        </a>
                    </div>
...
<?php echo $__env->make('front.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/d/dmitryty/test.palmeri.us/resources/views/front/pages/dunkermotoren.blade.php ENDPATH**/ ?>