<section class="offer">
    <div class="container">
        <form method="POST" action="<?php echo e(route('pages.offers.store')); ?>">
            <?php echo csrf_field(); ?>
...
</section><?php /**PATH /home/d/dmitryty/test.palmeri.us/resources/views/front/pages/components/offer.blade.php ENDPATH**/ ?>