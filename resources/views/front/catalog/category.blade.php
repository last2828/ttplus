  ...
  <section class="main-catalog__content">
    <div class="container"><a href="#" class="btn btn-single-param__heading btn-filter"><span class="span-text">Фильтры</span><span class="span-arrow"></span></a>
      ...
      <div class="products">
        ...
        {{--Получаем список всех товаров в категории производителя Jianghai--}}
          @php
            /**
            ...
            */
          @endphp
          @if (isset($category) && $category->groups->isEmpty())
            <div class="product__block">
              ...
              @foreach ($category->products as $product)
                <div class="product__series">
                  ...
                  <a href="{{
                  route('pages.catalog.jianghai.product',
                          ['category' => $category->slug, 'product' => $product->slug])
                  }}" class="btn btn-next">
          ...
          @elseif (isset($category) && empty($group))
            ...
            <div class="product__block">
              ...
              @foreach ($group->products as $product)
                <div class="product__series">
                  ...
                  <a href="{{ route('pages.catalog.dunkermotoren.product', ['category' => $category->slug, 'group' => $group->slug, 'product' => $product->slug]) }}" class="btn btn-next">
                    <div class="span-arrow"></div>
                  </a>
                </div>
              @endforeach
              <div class="block__bottom"><a href="{{ route('pages.catalog.dunkermotoren.group', ['category' => $category->slug, 'group' => $group->slug]) }}" class="btn btn-primary">Показать все позиции</a><a href="#" class="btn btn-next--blue">Индивидуальный заказ<span class="span-arrow"></span></a></div>
            </div>
            @endforeach
          ...
          <div class="product__block">
            ...
            @foreach ($group->products as $product)
              <div class="product__series">
                ...
                <a href="{{
                  route('pages.catalog.dunkermotoren.product',
                          ['category' => $group->category->slug, 'group' => $group->slug, 'product' => $product->slug])
                  }}" class="btn btn-next">
                  <div class="span-arrow"></div>
                </a>
              </div>
