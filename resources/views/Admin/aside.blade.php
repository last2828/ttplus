                ...
                <li aria-haspopup="true" class="kt-menu__item kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover">
                    ...
                    <div class="kt-menu__submenu">
                        ...
                        <ul class="kt-menu__subnav">
                            ...
                            <li aria-haspopup="true" class="kt-menu__item kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover">
                                <a class="kt-menu__link kt-menu__toggle" href="#"><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">Категории блога</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            </li>
                        </ul>
                    </div>
                </li>
